    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FoodRecipeSharingApp.category')),
                ('ingredients', models.ManyToManyField(to='FoodRecipeSharingApp.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
